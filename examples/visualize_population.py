...
def main():
    ...
    fig8.savefig("plots/areas_population.png", dpi=150)
    print("  ✓ plots/areas_population.png")
    
    fig9 = plotting.compare_areas(areas, metric="cars_per_capita")
    fig9.savefig("plots/areas_cars.png", dpi=150)
    print("  ✓ plots/areas_cars.png")
